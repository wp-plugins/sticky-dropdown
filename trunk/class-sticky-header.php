...
class Sticky_Dropdown {
	...
	public function print_admin_pointer_scripts() {
		$pointer_content  = '<h3>' . __( 'Sticky Header by engrmostafijur', $this->plugin_slug ) . '</h3>';
		$pointer_content .= sprintf(
			...
			'http://pixelsolution4it.com',
			'http://twitter.com/engrmostafijur',
			'https://wordpress.org/plugins/sticky-dropdown/'
		);
		?>
